...
if($almaira_shop_default_container =='fullwidth'){
 $almaira_style.="#page .container{max-width:{$almaira_shop_conatiner_width}px;}"; 
  ...
  $almaira_style.="#page .container{max-width:100%;} #page.almaira-site,header.shrink{max-width:{$almaira_shop_conatiner_maxwidth}px; margin:{$almaira_shop_conatiner_top_btm}px auto;}"; 
}
