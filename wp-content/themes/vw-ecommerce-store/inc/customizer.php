...
function vw_ecommerce_store_customize_register( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial(
		'vw_ecommerce_store_top_discount_box', array( 
	...
	//Selective Refresh
	$wp_customize->selective_refresh->add_partial(
		'vw_ecommerce_store_location', array( 
    ...
    //Selective Refresh
    $wp_customize->selective_refresh->add_partial(
    	'vw_ecommerce_store_slider_hide_show',array(
	...
	//Selective Refresh
	$wp_customize->selective_refresh->add_partial(
		'vw_ecommerce_store_toggle_postdate', array( 
    ...
    $wp_customize->add_setting('vw_ecommerce_store_excerpt_settings',array(
        'default' => __('Excerpt','vw-ecommerce-store'),
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_ecommerce_store_sanitize_choices'
	));
	...
	$wp_customize->add_setting('vw_ecommerce_store_related_posts_taxonomy',array(
        'default' => '',
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_ecommerce_store_sanitize_choices'
	));
	$wp_customize->add_control('vw_ecommerce_store_related_posts_taxonomy',array(
        'type' => 'select',
        'label' => __('Related Post Taxonomy','vw-ecommerce-store'),
        'section' => 'vw_ecommerce_store_related_posts_settings',
        'choices' => array(
        	'category' => __('Category','vw-ecommerce-store'),
            'tag' => __('Tags','vw-ecommerce-store')
        ),
	) );
	...
	//Selective Refresh
	$wp_customize->selective_refresh->add_partial(
		'vw_ecommerce_store_footer_text', array( 
	...
	$wp_customize->add_setting('vw_ecommerce_store_copyright_alingment',array(
        'default' => __('center','vw-ecommerce-store'),
        'sanitize_callback' => 'vw_ecommerce_store_sanitize_choices'
	));
    ...
    //Selective Refresh
	$wp_customize->selective_refresh->add_partial(
		'vw_ecommerce_store_scroll_to_top_icon', array( 
			'selector' => '.scrollup i', 
