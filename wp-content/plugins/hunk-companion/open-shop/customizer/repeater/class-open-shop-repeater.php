...
class Open_Shop_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'open_customizer-repeater-fontawesome-iconpicker-script', HUNK_COMPANION_PLUGIN_DIR_URL . '/open-shop/customizer/repeater/icon-picker/icon-picker.css', array(), '1.0.0' );
	}
			...
			<div class="customizer-repeater-social-repeater">
				...
				foreach ( $social_repeater as $social_icon ) {
					...
					if ( ! empty( $social_icon['icon'] ) ) {
						...
						echo '<input type="text" class="customizer-repeater-social-repeater-link" placeholder="' . esc_attr__( 'Link', 'open-shop' ) . '" value="';
